function initModals() {
    ...
    const cartObserver = new MutationObserver(actualizarContadores);
    const favoriteObserver = new MutationObserver(actualizarContadores);

    cartObserver.observe(cartItemsContainer, observerConfig);
    favoriteObserver.observe(favoriteItemsContainer, observerConfig);

    // Inicializamos los contadores desde el inicio
